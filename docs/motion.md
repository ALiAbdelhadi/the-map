...
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Hero `898:20007`                                                 | auto-cycles the ten states in ring order every 0.8 s; click jumps; 0.3 s ease-out. Smart Animate matches layers by name, so the chosen service flies from its ring slot to the top and grows (120 → ~560 px) while the previous one flies back into its slot — nothing fades in from nowhere     |
