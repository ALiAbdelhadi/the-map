  ...
  reviews: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "منة حمزة",
        rating: "4.5/5",
        quote: "عجبني نظام التقييمات لأنه خلّى الاختيار أسهل وبثقة أكبر.",
      ...
      },
      {
        ...
        name: "محمود علي",
        rating: "4.5/5",
        quote: "خدمة سريعة، منظمة بشكل جيد، وكل شيء كان واضحًا من البداية حتى النهاية.",
      ...
      },
      {
        ...
        name: "نورهان سمير",
        rating: "4/5",
        quote: "جربت عدة خدمات، وفي كل مرة كانت التجربة احترافية للغاية.",
