  ...
  reviews: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Menna Hamza",
        rating: "4.5/5",
        quote: "I loved the review system — it made choosing easy and confident.",
      ...
      },
      {
        ...
        name: "Mahmoud Ali",
        rating: "4.5/5",
        quote: "Fast service, well organized, and everything was clear from start to finish",
      ...
      },
      {
        ...
        name: "Nourhan Samir",
        rating: "4/5",
        quote: "I tried multiple services and each time the experience was very professional.",
