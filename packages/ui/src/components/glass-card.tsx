 ...
 * The card and the header bar both show the GLASS effect's 1 px light edge in every
 * frame (`shadow-glass-edge`); the Why Choose Us `field` surface does not get it.
 */
...
const SURFACES = {
  ...
  header:
    "bg-surface-header shadow-glass-edge rounded-button px-3.5 py-3.75 tablet:px-5 tablet:py-6 desktop:rounded-header desktop:p-5",
